...
$$
    DECLARE
        ...
        -- ── Usuários – Staff ───────────────────────────────────────────────────
        user_dr_ana      UUID := 'seed0001-0000-0000-0000-000000000001';
        user_dr_carlos   UUID := 'seed0001-0000-0000-0000-000000000002';
        user_enf_maria   UUID := 'seed0001-0000-0000-0000-000000000003';
        user_enf_joao    UUID := 'seed0001-0000-0000-0000-000000000004';
        user_ger_roberto UUID := 'seed0001-0000-0000-0000-000000000005';

        -- ── Usuários – Familiares ──────────────────────────────────────────────
        user_fernanda UUID := 'seed0001-0000-0000-0000-000000000006';
        user_paulo    UUID := 'seed0001-0000-0000-0000-000000000007';
        user_carolina UUID := 'seed0001-0000-0000-0000-000000000008';
        user_marcos   UUID := 'seed0001-0000-0000-0000-000000000009';
        user_ana_fam  UUID := 'seed0001-0000-0000-0000-000000000010';

        -- ── Funcionários ──────────────────────────────────────────────────────
        emp_dr_ana      UUID := 'seed0002-0000-0000-0000-000000000001';
        emp_dr_carlos   UUID := 'seed0002-0000-0000-0000-000000000002';
        emp_enf_maria   UUID := 'seed0002-0000-0000-0000-000000000003';
        emp_enf_joao    UUID := 'seed0002-0000-0000-0000-000000000004';
        emp_ger_roberto UUID := 'seed0002-0000-0000-0000-000000000005';

        -- ── Residentes ────────────────────────────────────────────────────────
        res_maria   UUID := 'seed0003-0000-0000-0000-000000000001';
        res_jose    UUID := 'seed0003-0000-0000-0000-000000000002';
        res_rosa    UUID := 'seed0003-0000-0000-0000-000000000003';
        res_antonio UUID := 'seed0003-0000-0000-0000-000000000004';
        res_luiza   UUID := 'seed0003-0000-0000-0000-000000000005';

        -- ── Prontuários ───────────────────────────────────────────────────────
        hrec_maria   UUID := 'seed0004-0000-0000-0000-000000000001';
        hrec_jose    UUID := 'seed0004-0000-0000-0000-000000000002';
        hrec_rosa    UUID := 'seed0004-0000-0000-0000-000000000003';
        hrec_antonio UUID := 'seed0004-0000-0000-0000-000000000004';
        hrec_luiza   UUID := 'seed0004-0000-0000-0000-000000000005';

        -- ── Histórico de prontuário ────────────────────────────────────────────
        hh_maria_1   UUID := 'seed0005-0000-0000-0000-000000000001';
        hh_maria_2   UUID := 'seed0005-0000-0000-0000-000000000002';
        hh_jose_1    UUID := 'seed0005-0000-0000-0000-000000000003';
        hh_rosa_1    UUID := 'seed0005-0000-0000-0000-000000000004';
        hh_antonio_1 UUID := 'seed0005-0000-0000-0000-000000000005';
        hh_luiza_1   UUID := 'seed0005-0000-0000-0000-000000000006';

        -- ── Registros de atividade ─────────────────────────────────────────────
        act_maria   UUID := 'seed0006-0000-0000-0000-000000000001';
        act_jose    UUID := 'seed0006-0000-0000-0000-000000000002';
        act_rosa    UUID := 'seed0006-0000-0000-0000-000000000003';
        act_antonio UUID := 'seed0006-0000-0000-0000-000000000004';
        act_luiza   UUID := 'seed0006-0000-0000-0000-000000000005';

        -- ── Histórico de atividades ────────────────────────────────────────────
        ach_maria_1   UUID := 'seed0007-0000-0000-0000-000000000001';
        ach_maria_2   UUID := 'seed0007-0000-0000-0000-000000000002';
        ach_jose_1    UUID := 'seed0007-0000-0000-0000-000000000003';
        ach_rosa_1    UUID := 'seed0007-0000-0000-0000-000000000004';
        ach_antonio_1 UUID := 'seed0007-0000-0000-0000-000000000005';
        ach_luiza_1   UUID := 'seed0007-0000-0000-0000-000000000006';

        -- ── Prescrições ───────────────────────────────────────────────────────
        presc_maria_1   UUID := 'seed0008-0000-0000-0000-000000000001';
        presc_maria_2   UUID := 'seed0008-0000-0000-0000-000000000002';
        presc_jose_1    UUID := 'seed0008-0000-0000-0000-000000000003';
        presc_rosa_1    UUID := 'seed0008-0000-0000-0000-000000000004';
        presc_antonio_1 UUID := 'seed0008-0000-0000-0000-000000000005';
        presc_antonio_2 UUID := 'seed0008-0000-0000-0000-000000000006';
        presc_luiza_1   UUID := 'seed0008-0000-0000-0000-000000000007';

        -- ── Registros de medicamentos ──────────────────────────────────────────
        mrec_1 UUID := 'seed0009-0000-0000-0000-000000000001';
        mrec_2 UUID := 'seed0009-0000-0000-0000-000000000002';
        mrec_3 UUID := 'seed0009-0000-0000-0000-000000000003';
        mrec_4 UUID := 'seed0009-0000-0000-0000-000000000004';
        mrec_5 UUID := 'seed0009-0000-0000-0000-000000000005';
        mrec_6 UUID := 'seed0009-0000-0000-0000-000000000006';

        -- ── Vínculos familiares ────────────────────────────────────────────────
        fl_maria_fern    UUID := 'seed0010-0000-0000-0000-000000000001';
        fl_maria_paulo   UUID := 'seed0010-0000-0000-0000-000000000002';
        fl_jose_paulo    UUID := 'seed0010-0000-0000-0000-000000000003';
        fl_rosa_carol    UUID := 'seed0010-0000-0000-0000-000000000004';
        fl_antonio_marcos UUID := 'seed0010-0000-0000-0000-000000000005';
        fl_luiza_ana     UUID := 'seed0010-0000-0000-0000-000000000006';
