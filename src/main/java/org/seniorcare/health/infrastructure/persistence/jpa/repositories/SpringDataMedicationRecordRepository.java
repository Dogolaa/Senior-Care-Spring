...
@Repository
public interface SpringDataMedicationRecordRepository extends JpaRepository<MedicationRecordModel, UUID> {

    List<MedicationRecordModel> findByResidentId(UUID residentId);
}
